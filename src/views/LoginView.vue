  ...
  <main class="h-full flex justify-center items-center">
    <div>
      ...
      <form action="#">
        ...
        <div>
          <input type="text" v-model="phoneNumber" @input="formatPhoneNumber" placeholder="+994 (00) 000 0000">
          <button class="button text-2xl mb-2">Yoxla</button>
        </div>
      </form>
      <form action="#">
        <label for="phone" class="mb-1 ml-2.5">E-unvan</label>
        <div>
          <input type="text" v-model="phoneNumber" @input="formatPhoneNumber" placeholder="name@domain.xyz">
